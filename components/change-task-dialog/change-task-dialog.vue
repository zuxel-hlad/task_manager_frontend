<template>
  ...
  >
      ...
      <div class="flex flex-wrap gap-x-3 gap-y-1">
        ...
        >
          <input
            ...
            type="checkbox"
            :value="person"
            :checked="responsiblePerson.includes(person)"
          />
          <span>{{ person }}</span>
        </label>
      </div>
    ...
    <div
      class="flex flex-col items-start justify-center gap-3 sm:flex-row sm:gap-8"
    >
      <button
        type="button"
...
import {
  fakePerformers,
  fakeResponsiblePersons,
} from "~/components/create-task-dialog/fake-data";
